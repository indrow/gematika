export default function Page() {
  return (
    <>
      <div className="flex mx-auto px-4 py-24 max-w-screen-xl">
        <div className="w-100 md:w-1/2 text-center md:text-left">
          <h1 className="text-6xl font-['Titillium_Web'] py-4">Gematika</h1>
          <p className="text-xl">
      ...
      <div className="flex mx-auto px-4 py-24 max-w-screen-xl">
        <h3 className="font-bold text-md uppercase text-cyan-500">Kategori</h3>
      </div>
      <div className="flex mx-auto px-4 py-24 max-w-screen-xl"></div>
    </>
  );
}
